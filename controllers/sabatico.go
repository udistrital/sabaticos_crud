...
// @Success 201 {int} models.Sabatico
// @Failure 403 body is empty
// @router / [post]
func (c *SabaticoController) Post() {
	var v models.Sabatico
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSabatico(&v); err == nil {
...
func (c *SabaticoController) GetOne() {
	...
	v, err := models.GetSabaticoById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
func (c *SabaticoController) GetAll() {
	...
	l, err := models.GetAllSabatico(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
func (c *SabaticoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Sabatico{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateSabaticoById(&v); err == nil {
...
func (c *SabaticoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSabatico(id); err == nil {
