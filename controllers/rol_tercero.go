...
// RolTerceroController operations for RolTercero
type RolTerceroController struct {
	beego.Controller
}

// URLMapping ...
func (c *RolTerceroController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create RolTercero
// @Param	body		body 	models.RolTercero	true		"body for RolTercero content"
// @Success 201 {int} models.RolTercero
// @Failure 403 body is empty
// @router / [post]
func (c *RolTerceroController) Post() {
	var v models.RolTercero
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddRolTercero(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get RolTercero by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.RolTercero
// @Failure 403 :id is empty
// @router /:id [get]
func (c *RolTerceroController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetRolTerceroById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// @Failure 403
// @router / [get]
func (c *RolTerceroController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllRolTercero(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// Put ...
// @Title Put
// @Description update the RolTercero
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.RolTercero	true		"body for RolTercero content"
// @Success 200 {object} models.RolTercero
// @Failure 403 :id is not int
// @router /:id [put]
func (c *RolTerceroController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.RolTercero{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateRolTerceroById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the RolTercero
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *RolTerceroController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteRolTercero(id); err == nil {
