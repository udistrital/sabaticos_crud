...
// FormularioSolicitudController operations for FormularioSolicitud
type FormularioSolicitudController struct {
	beego.Controller
}

// URLMapping ...
func (c *FormularioSolicitudController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create FormularioSolicitud
// @Param	body		body 	models.FormularioSolicitud	true		"body for FormularioSolicitud content"
// @Success 201 {int} models.FormularioSolicitud
// @Failure 403 body is empty
// @router / [post]
func (c *FormularioSolicitudController) Post() {
	var v models.FormularioSolicitud
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddFormularioSolicitud(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get FormularioSolicitud by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.FormularioSolicitud
// @Failure 403 :id is empty
// @router /:id [get]
func (c *FormularioSolicitudController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetFormularioSolicitudById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// GetAll ...
// @Title Get All
// @Description get FormularioSolicitud
...
// @Failure 403
// @router / [get]
func (c *FormularioSolicitudController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllFormularioSolicitud(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// Put ...
// @Title Put
// @Description update the FormularioSolicitud
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.FormularioSolicitud	true		"body for FormularioSolicitud content"
// @Success 200 {object} models.FormularioSolicitud
// @Failure 403 :id is not int
// @router /:id [put]
func (c *FormularioSolicitudController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.FormularioSolicitud{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateFormularioSolicitudById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the FormularioSolicitud
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *FormularioSolicitudController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteFormularioSolicitud(id); err == nil {
