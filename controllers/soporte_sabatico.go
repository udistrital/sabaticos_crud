...
// SoporteSabaticoController operations for SoporteSabatico
...
// Post ...
// @Title Post
// @Description create SoporteSabatico
// @Param	body		body 	models.SoporteSabatico	true		"body for SoporteSabatico content"
// @Success 201 {int} models.SoporteSabatico
// @Failure 403 body is empty
// @router / [post]
func (c *SoporteSabaticoController) Post() {
	var v models.SoporteSabatico
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSoporteSabatico(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get SoporteSabatico by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.SoporteSabatico
// @Failure 403 :id is empty
// @router /:id [get]
func (c *SoporteSabaticoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSoporteSabaticoById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// GetAll ...
// @Title Get All
// @Description get SoporteSabatico
...
// @Failure 403
// @router / [get]
func (c *SoporteSabaticoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllSoporteSabatico(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// Put ...
// @Title Put
// @Description update the SoporteSabatico
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.SoporteSabatico	true		"body for SoporteSabatico content"
// @Success 200 {object} models.SoporteSabatico
// @Failure 403 :id is not int
// @router /:id [put]
func (c *SoporteSabaticoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.SoporteSabatico{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateSoporteSabaticoById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the SoporteSabatico
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *SoporteSabaticoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSoporteSabatico(id); err == nil {
