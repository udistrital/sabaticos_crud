...
// EstadoSoporteSabaticoController operations for EstadoSoporteSabatico
type EstadoSoporteSabaticoController struct {
	beego.Controller
}

// URLMapping ...
func (c *EstadoSoporteSabaticoController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create EstadoSoporteSabatico
// @Param	body		body 	models.EstadoSoporteSabatico	true		"body for EstadoSoporteSabatico content"
// @Success 201 {int} models.EstadoSoporteSabatico
// @Failure 403 body is empty
// @router / [post]
func (c *EstadoSoporteSabaticoController) Post() {
	var v models.EstadoSoporteSabatico
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEstadoSoporteSabatico(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get EstadoSoporteSabatico by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.EstadoSoporteSabatico
// @Failure 403 :id is empty
// @router /:id [get]
func (c *EstadoSoporteSabaticoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetEstadoSoporteSabaticoById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// GetAll ...
// @Title Get All
// @Description get EstadoSoporteSabatico
...
// @Failure 403
// @router / [get]
func (c *EstadoSoporteSabaticoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllEstadoSoporteSabatico(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// Put ...
// @Title Put
// @Description update the EstadoSoporteSabatico
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.EstadoSoporteSabatico	true		"body for EstadoSoporteSabatico content"
// @Success 200 {object} models.EstadoSoporteSabatico
// @Failure 403 :id is not int
// @router /:id [put]
func (c *EstadoSoporteSabaticoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.EstadoSoporteSabatico{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateEstadoSoporteSabaticoById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the EstadoSoporteSabatico
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *EstadoSoporteSabaticoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteEstadoSoporteSabatico(id); err == nil {
