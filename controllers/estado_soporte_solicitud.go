...
// EstadoSoporteSolicitudController operations for EstadoSoporteSolicitud
type EstadoSoporteSolicitudController struct {
	beego.Controller
}

// URLMapping ...
func (c *EstadoSoporteSolicitudController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create EstadoSoporteSolicitud
// @Param	body		body 	models.EstadoSoporteSolicitud	true		"body for EstadoSoporteSolicitud content"
// @Success 201 {int} models.EstadoSoporteSolicitud
// @Failure 403 body is empty
// @router / [post]
func (c *EstadoSoporteSolicitudController) Post() {
	var v models.EstadoSoporteSolicitud
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEstadoSoporteSolicitud(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get EstadoSoporteSolicitud by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.EstadoSoporteSolicitud
// @Failure 403 :id is empty
// @router /:id [get]
func (c *EstadoSoporteSolicitudController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetEstadoSoporteSolicitudById(id)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// GetAll ...
// @Title Get All
// @Description get EstadoSoporteSolicitud
...
// @Failure 403
// @router / [get]
func (c *EstadoSoporteSolicitudController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllEstadoSoporteSolicitud(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		c.Ctx.Output.SetStatus(400)
...
// Put ...
// @Title Put
// @Description update the EstadoSoporteSolicitud
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.EstadoSoporteSolicitud	true		"body for EstadoSoporteSolicitud content"
// @Success 200 {object} models.EstadoSoporteSolicitud
// @Failure 403 :id is not int
// @router /:id [put]
func (c *EstadoSoporteSolicitudController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.EstadoSoporteSolicitud{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaCreacion = time_bogota.TiempoCorreccionFormato(v.FechaCreacion)
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateEstadoSoporteSolicitudById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the EstadoSoporteSolicitud
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *EstadoSoporteSolicitudController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteEstadoSoporteSolicitud(id); err == nil {
